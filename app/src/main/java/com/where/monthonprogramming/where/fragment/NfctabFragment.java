...
public class NfctabFragment extends Fragment {
    ...
    public static NfctabFragment newInstance() {
        NfctabFragment fragment = new NfctabFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_nfctab, container, false);
